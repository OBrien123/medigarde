...
# --- Table mère concrète (sera créée en BDD) ---
class Utilisateur(models.Model):
    ...
    class Meta:
        # Pas abstract = True, donc table créée
        db_table = 'utilisateur'

# --- Tables filles avec OneToOneField ---
class Client(models.Model):
    utilisateur = models.OneToOneField(Utilisateur, on_delete=models.CASCADE, primary_key=True)
    adresse = models.CharField(max_length=200)
    ville = models.CharField(max_length=100)
    code_postal = models.CharField(max_length=10)
    position_client = models.CharField(max_length=50, null=True, blank=True)
...
class Pharmacie(models.Model):
    ...
    statut = models.CharField(max_length=20, default='en_attente',
                              choices=[('en_attente','En attente'),('valide','Valide'),('suspendu','Suspendu')])
...
class Administrateur(models.Model):
    utilisateur = models.OneToOneField(Utilisateur, on_delete=models.CASCADE, primary_key=True)
    # Pas de champs supplémentaires, mais pourrait en avoir
...
class Medicament(models.Model):
    ...
    forme = models.CharField(max_length=50, choices=[('comprimé','Comprimé'),('sirop','Sirop'),('gélule','Gélule'),('injectable','Injectable')])
...
class Stock(models.Model):
    ...
    class Meta:
        db_table = 'stock'
        unique_together = [['medicament', 'pharmacie']]  # clé composite
